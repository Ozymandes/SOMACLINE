...
First public release. The console is a native Rust application on winit +
softbuffer, with cairo and pango doing the drawing and no GTK linked.
...
- Six generated hardware modules — shell, header, observation chamber,
  ...
  into recesses measured off the module. Nothing on the machine is a baked
  reading.
...
|---|---:|---:|
| PSS | 184.9 MB | **44.6–47.8 MB** |
| focused CPU | 17.5 % | **15.1–16.0 %** |
